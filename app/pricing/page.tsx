          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="rounded-2xl border p-6 bg-gradient-to-b from-white to-gray-50">
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2"><CheckCircle2 size={18}/> Analysts, coordinators</li>
            ...
            <div className="rounded-2xl border p-6 bg-gradient-to-b from-white to-gray-50">
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2"><CheckCircle2 size={18}/> Associates, engineers</li>
            ...
            <div className="rounded-2xl border p-6 bg-gradient-to-b from-white to-gray-50">
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2"><CheckCircle2 size={18}/> Leads, managers</li>
