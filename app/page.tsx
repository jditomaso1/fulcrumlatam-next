        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          ...
          >
            {[
              ...
              { src: "/logos/sio.png",              alt: "Sio",             liClass: "h-30", imgClass: "max-h-30 md:max-h-12" },
              ...
              { src: "/logos/lendsmart.png",        alt: "Lendsmart",       liClass: "h-30", imgClass: "max-h-30 md:max-h-14" }, // smaller
            ].map((logo) => (
              <li
                key={logo.alt}
