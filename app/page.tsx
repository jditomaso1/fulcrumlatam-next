        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          ...
          >
            {[
              ...
              { src: "/logos/deckard.png",          alt: "Deckard",         liClass: "h-17", imgClass: "max-h-18 md:max-h-16" },
              { src: "/logos/merritt.png",          alt: "Merritt",         liClass: "h-20", imgClass: "max-h-20 md:max-h-19" },
              { src: "/logos/lendsmart.png",        alt: "Lendsmart",       liClass: "h-17", imgClass: "max-h-18 md:max-h-16" }, // smaller
            ].map((logo) => (
              <li
                key={logo.alt}
