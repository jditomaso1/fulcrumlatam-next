        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          ...
          >
            {[
              ...
              { src: "/logos/deckard.png",          alt: "Deckard",         liClass: "h-14", imgClass: "max-h-14 md:max-h-14" },
              { src: "/logos/merritt.png",          alt: "Merritt",         liClass: "h-19", imgClass: "max-h-19 md:max-h-19" },
              { src: "/logos/lendsmart.png",        alt: "Lendsmart",       liClass: "h-14", imgClass: "max-h-14 md:max-h-14" }, // smaller
            ].map((logo) => (
              <li
                key={logo.alt}
